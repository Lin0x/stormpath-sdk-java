...
In the box labeled “Authorized Redirect URIs”, enter your redirect URL – this should be set to something like: ``https://www.mysite.com/idSiteResult``. If you’re testing locally, you might want to set this to: ``http://localhost:${port}/idSiteResult``
